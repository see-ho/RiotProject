package com.seeho.designsystem.component
...
import com.seeho.designsystem.theme.RpTheme
 ...
 */
@Composable
fun RowScope.RpNavigationBarItem(
    selected: Boolean,
    onClick: () -> Unit,
...
@Preview
@Composable
fun RpNavigationPreview() {
    val items = listOf("Home", "Bookmarks")
    val icons = listOf(
        RpIcons.HomeBorder,
        RpIcons.BookmarksBorder,
    )

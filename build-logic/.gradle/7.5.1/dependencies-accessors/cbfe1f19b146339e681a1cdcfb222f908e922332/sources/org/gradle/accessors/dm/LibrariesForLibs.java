...
public class LibrariesForLibs extends AbstractExternalDependencyFactory {
    ...
    public static class PluginAccessors extends PluginFactory {
        ...
        private final RiotprojectPluginAccessors baccForRiotprojectPluginAccessors = new RiotprojectPluginAccessors(providers, config);
        ...
        /**
         * Returns the group of bundles at plugins.riotproject
         */
        public RiotprojectPluginAccessors getRiotproject() { return baccForRiotprojectPluginAccessors; }
    ...
    public static class RiotprojectPluginAccessors extends PluginFactory {
        private final RiotprojectAndroidPluginAccessors baccForRiotprojectAndroidPluginAccessors = new RiotprojectAndroidPluginAccessors(providers, config);
        private final RiotprojectJvmPluginAccessors baccForRiotprojectJvmPluginAccessors = new RiotprojectJvmPluginAccessors(providers, config);

        public RiotprojectPluginAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }

        /**
         * Returns the group of bundles at plugins.riotproject.android
         */
        public RiotprojectAndroidPluginAccessors getAndroid() { return baccForRiotprojectAndroidPluginAccessors; }

        /**
         * Returns the group of bundles at plugins.riotproject.jvm
         */
        public RiotprojectJvmPluginAccessors getJvm() { return baccForRiotprojectJvmPluginAccessors; }

    }

    public static class RiotprojectAndroidPluginAccessors extends PluginFactory {
        private final RiotprojectAndroidApplicationPluginAccessors baccForRiotprojectAndroidApplicationPluginAccessors = new RiotprojectAndroidApplicationPluginAccessors(providers, config);
        private final RiotprojectAndroidLibraryPluginAccessors baccForRiotprojectAndroidLibraryPluginAccessors = new RiotprojectAndroidLibraryPluginAccessors(providers, config);
        ...
        /**
         * Returns the group of bundles at plugins.riotproject.android.application
         */
        public RiotprojectAndroidApplicationPluginAccessors getApplication() { return baccForRiotprojectAndroidApplicationPluginAccessors; }

        /**
         * Returns the group of bundles at plugins.riotproject.android.library
         */
        public RiotprojectAndroidLibraryPluginAccessors getLibrary() { return baccForRiotprojectAndroidLibraryPluginAccessors; }
